...
function ltrFn() {
    let html = document.querySelector('html')
    document.querySelector("#style")?.setAttribute("href", "../static/libs/bootstrap/css/bootstrap.min.css");
    html.setAttribute("dir", "ltr");
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "../static/libs/bootstrap/css/bootstrap.rtl.min.css");
    checkOptions();
}
